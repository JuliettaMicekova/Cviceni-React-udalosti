...
const Pozdrav = ({ jmenoVeCtvrtemPade, jmenoVPatemPade }) => {
  return (
    <button
      onClick={() => {
        alert(`Ahoj ${jmenoVeCtvrtemPade}`);
      }}
    >
      Pozdrav:{jmenoVPatemPade}
    </button>
  );
};
...
export const Uloha4 = () => {
  return (
    <>
      ...
      <Pozdrav jmenoVeCtvrtemPade="Júlia" jmenoVPatemPade="Júlie" />
      <Pozdrav jmenoVeCtvrtemPade="Dan" jmenoVPatemPade="Dane" />
    </>
  );
};
